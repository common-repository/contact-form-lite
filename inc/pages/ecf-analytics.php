...
<div class="cfp-main-form cfp-main-form2">
  <div class="charts">
    ...
    <p style="padding-left: 20px;border-bottom: 1px solid #E1E1E1;padding-bottom: 10px;">This feature only available in <strong>Pro Version</strong>. You can see version comparison <a style="text-decoration:none !important;" href="<?php echo esc_url( admin_url( 'edit.php?post_type=easycontactform&page=easycform_comparison' ) ); ?>">here</a>.</p>
