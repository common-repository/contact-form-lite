...
with (obj) {
__p += '<label>\n  <span>' +
((__t = (_.escape(Formbuilder.helpers.simple_format(rf.get(Formbuilder.options.mappings.LABEL))))) == null ? '' : __t) +
'\n  ';
