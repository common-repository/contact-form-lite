...
== Description ==
[Homepage](https://demo.ghozylab.com/plugins/easy-contact-form-plugin/) | [Documentation](https://www.youtube.com/watch?v=_3lsRi9C77k) | [Support](https://ghozylab.com/plugins/submit-support-request/#tab-1399384216-2-4) | [Demo](https://demo.ghozylab.com/plugins/easy-contact-form-plugin/demo-form-with-image-in-header/) | [Premium Version](https://demo.ghozylab.com/plugins/easy-contact-form-plugin/)
...
Not only does the form plugin take care of the functionality, it can very easily make your [form](https://demo.ghozylab.com/plugins/easy-contact-form-plugin/ "contact form") look great too. For the more advanced user, you will NOT be disappointed with the flexibility of the styling features of this **form plugin**.
...
Take your form to the next level with [Contact Form Pro](https://demo.ghozylab.com/plugins/easy-contact-form-plugin/pricing-compare-tables/ "best contact form plugin"), which gives you additional features such as:
...
* Prevent spam with 4 CAPTCHA options: CAPTCHA image, reCAPTCHA v2 or reCAPTCHA v3 and more than 5 reCAPTCHA skin
* 24/7 Technical Support

### Recommended Plugins
The following are other recommended plugins by the author:

* [Gallery](https://wordpress.org/plugins/easy-media-gallery/ "gallery plugin") - Easy Media Gallery is a wordpress plugin designed to display various media support including grid gallery, galleries, photo album, multiple photo albums, portfolio, photo gallery or image gallery.
...
* [Popup Builder](https://wordpress.org/plugins/easy-notify-lite/ "optin form plugin") -  The Best Notify and Subscription Form Plugin to display notify popup, announcement and subscribe form with very ease, fancy and elegant.
...
* We are not able to provide anything other than [community based support](https://wordpress.org/support/plugin/contact-form-lite) for Contact Form Plugin. Please consider upgrading to [Contact Form Plugin Professional](https://demo.ghozylab.com/plugins/easy-contact-form-plugin/) for support.
...
= 1.1.25 =
* Fixed : IMPORTANT! SECURITY BUGS FIX, PLEASE UPDATE NOW!
...
= 1.1.19 =
* Fixed : WordPress filters for Addons compatibility
* Fixed : Many other PHP and CSS clean and optimization
...
= 1.1.10 =
* Fixed : Security bugs, PLEASE UPDATE NOW!
...
* Fixed : Loading animation when send an email

= 1.1.5 =
* Fixed : PHP error on several form fields
* Fixed : Many other PHP and CSS clean and optimization
...
= 1.0.99 =
* Tweak : Add Form Block to make it easier for you to put the form into your post / page
* Fixed : Widget not available in Appearance > Widgets
* Fixed : Many other PHP and CSS clean and optimization
